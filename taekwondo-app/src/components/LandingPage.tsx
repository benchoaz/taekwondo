...
function formatSocialUrl(url?: string | null, fallback = ""): string {
...
export default function LandingPage({ 
  ...
  useEffect(() => {
    // Fetch Settings with cache buster
    fetch(`/api/settings?_t=${Date.now()}`, { cache: "no-store", headers: { "Pragma": "no-cache" } })
      .then(res => res.json())
      .then(data => {
          ...
          <div>
            ...
            <div className="mt-6 pt-4 border-t border-white/10">
              ...
              <div className="flex items-center gap-2.5 flex-wrap">
                {/* TikTok */}
                <a
                  href={formatSocialUrl(settings.tiktokUrl, "https://www.tiktok.com/@white_t1ger_club")}
                  target="_blank"
                  rel="noopener noreferrer"
                  ...
                  title={settings.tiktokUrl ? `Kunjungi TikTok: ${settings.tiktokUrl}` : "TikTok White Tiger"}
                >
                ...
                {/* Telegram */}
                <a
                  href={formatSocialUrl(settings.telegramUrl, "https://t.me/whitetigerkraksaan")}
                  target="_blank"
                  rel="noopener noreferrer"
                  ...
                  title={settings.telegramUrl ? `Kunjungi Telegram: ${settings.telegramUrl}` : "Telegram White Tiger"}
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                ...
                {/* Facebook */}
                <a
                  href={formatSocialUrl(settings.facebookUrl, "https://www.facebook.com/whitetigerkraksaan")}
                  target="_blank"
                  rel="noopener noreferrer"
                  ...
                  title={settings.facebookUrl ? `Kunjungi Facebook: ${settings.facebookUrl}` : "Facebook White Tiger Kraksaan"}
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                ...
                {/* Instagram */}
                <a
                  href={formatSocialUrl(settings.instagramUrl, "https://www.instagram.com/whitetigerkraksaan")}
                  target="_blank"
                  rel="noopener noreferrer"
                  ...
                  title={settings.instagramUrl ? `Kunjungi Instagram: ${settings.instagramUrl}` : "Instagram White Tiger"}
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                ...
                {/* YouTube */}
                <a
                  href={formatSocialUrl(settings.youtubeUrl, "https://www.youtube.com/@whitetigerkraksaan")}
                  target="_blank"
                  rel="noopener noreferrer"
                  ...
                  title={settings.youtubeUrl ? `Kunjungi YouTube: ${settings.youtubeUrl}` : "YouTube White Tiger Kraksaan"}
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
